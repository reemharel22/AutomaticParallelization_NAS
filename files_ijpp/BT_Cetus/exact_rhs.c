...
void exact_rhs()
{
	...
	/* initialize                                   */
	/* --------------------------------------------------------------------- */
	#pragma cetus private(dtpp, eta, i, im1, ip1, j, jm1, jp1, k, km1, kp1, m, xi, zeta) 
...
//#pragma omp parallel for private(i, j, m)
		...
		#pragma loop name exact_rhs#0#1 
		for (k=1; k<=(grid_points[2]-2); k ++ )
		{
			zeta=(((double)k)*dnzm1);
			#pragma cetus private(dtpp, eta, i, im1, ip1, j, m, xi) 
			#pragma loop name exact_rhs#0#1#0 
			for (j=1; j<=(grid_points[1]-2); j ++ )
			{
				eta=(((double)j)*dnym1);
				#pragma cetus private(dtpp, i, m, xi) 
				#pragma loop name exact_rhs#0#1#0#0 
				for (i=0; i<=(grid_points[0]-1); i ++ )
				{
					xi=(((double)i)*dnxm1);
					exact_solution(xi, eta, zeta, dtemp);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#1#0#0#0 
					#pragma cetus parallel 
					/*
					...
					*/
					...
					dtpp=(1.0/dtemp[0]);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#1#0#0#1 
					#pragma cetus parallel 
					/*
					Disabled due to low profitability: #pragma omp parallel for private(m)
					*/
				...
				#pragma loop name exact_rhs#0#1#0#1 
				#pragma cetus parallel 
//#pragma omp parallel for private(i, im1, ip1)
				...
				/* --------------------------------------------------------------------- */
				#pragma cetus private(i, m) 
				#pragma loop name exact_rhs#0#1#0#2 
				#pragma cetus parallel 
				/*
				...
				*/
				...
				#pragma cetus private(i, m) 
				#pragma loop name exact_rhs#0#1#0#3 
				#pragma cetus parallel 
#pragma omp parallel for private(i, m)
				for (i=3; i<=(grid_points[0]-4); i ++ )
				{
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#1#0#3#0 
					for (m=0; m<5; m ++ )
					{
				...
				#pragma cetus private(i, m) 
				#pragma loop name exact_rhs#0#1#0#4 
				#pragma cetus parallel 
				/*
				Disabled due to low profitability: #pragma omp parallel for private(i, m)
				*/
		...
		#pragma loop name exact_rhs#0#2 
		for (k=1; k<=(grid_points[2]-2); k ++ )
		{
			zeta=(((double)k)*dnzm1);
			#pragma cetus private(dtpp, eta, i, j, jm1, jp1, m, xi) 
			#pragma loop name exact_rhs#0#2#0 
			for (i=1; i<=(grid_points[0]-2); i ++ )
			{
				xi=(((double)i)*dnxm1);
				#pragma cetus private(dtpp, eta, j, m) 
				#pragma loop name exact_rhs#0#2#0#0 
				for (j=0; j<=(grid_points[1]-1); j ++ )
				{
					eta=(((double)j)*dnym1);
					exact_solution(xi, eta, zeta, dtemp);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#2#0#0#0 
					#pragma cetus parallel 
					/*
					Disabled due to low profitability: #pragma omp parallel for private(m)
					*/
					...
					dtpp=(1.0/dtemp[0]);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#2#0#0#1 
					#pragma cetus parallel 
					/*
					Disabled due to low profitability: #pragma omp parallel for private(m)
					*/
				...
				#pragma loop name exact_rhs#0#2#0#1 
				#pragma cetus parallel 
#pragma omp parallel for private(j, jm1, jp1)
				...
				#pragma loop name exact_rhs#0#2#0#2 
				#pragma cetus parallel 
				/*
				...
				*/
				...
				#pragma cetus private(j, m) 
				#pragma loop name exact_rhs#0#2#0#3 
				#pragma cetus parallel 
#pragma omp parallel for private(j, m)
				...
				{
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#2#0#3#0 
					for (m=0; m<5; m ++ )
					{
				...
				#pragma cetus private(j, m) 
				#pragma loop name exact_rhs#0#2#0#4 
				#pragma cetus parallel 
				/*
				Disabled due to low profitability: #pragma omp parallel for private(j, m)
				*/
		...
		#pragma loop name exact_rhs#0#3 
		for (j=1; j<=(grid_points[1]-2); j ++ )
		{
			eta=(((double)j)*dnym1);
			#pragma cetus private(dtpp, i, k, km1, kp1, m, xi, zeta) 
			#pragma loop name exact_rhs#0#3#0 
			for (i=1; i<=(grid_points[0]-2); i ++ )
			{
				xi=(((double)i)*dnxm1);
				#pragma cetus private(dtpp, k, m, zeta) 
				#pragma loop name exact_rhs#0#3#0#0 
				for (k=0; k<=(grid_points[2]-1); k ++ )
				{
					zeta=(((double)k)*dnzm1);
					exact_solution(xi, eta, zeta, dtemp);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#3#0#0#0 
					#pragma cetus parallel 
					/*
					Disabled due to low profitability: #pragma omp parallel for private(m)
					*/
					...
					dtpp=(1.0/dtemp[0]);
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#3#0#0#1 
					#pragma cetus parallel 
					/*
					Disabled due to low profitability: #pragma omp parallel for private(m)
					*/
				...
				#pragma loop name exact_rhs#0#3#0#1 
				#pragma cetus parallel 
#pragma omp parallel for private(k, km1, kp1)
				...
				#pragma loop name exact_rhs#0#3#0#2 
				#pragma cetus parallel 
				/*
				...
				*/
				...
				#pragma cetus private(k, m) 
				#pragma loop name exact_rhs#0#3#0#3 
				#pragma cetus parallel 
#pragma omp parallel for private(k, m)
				...
				{
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#3#0#3#0 
					for (m=0; m<5; m ++ )
					{
				...
				#pragma cetus private(k, m) 
				#pragma loop name exact_rhs#0#3#0#4 
				#pragma cetus parallel 
				/*
				Disabled due to low profitability: #pragma omp parallel for private(k, m)
				*/
		...
		#pragma loop name exact_rhs#0#4 
		#pragma cetus parallel 
#pragma omp parallel for private(i, j, m) lastprivate(k)
		//#pragma omp parallel for if((10000<(((((((-137L+(72L*grid_points[0L]))+(66L*grid_points[1L]))+(69L*grid_points[2L]))+((-36L*grid_points[0L])*grid_points[1L]))+((-36L*grid_points[0L])*grid_points[2L]))+((-33L*grid_points[1L])*grid_points[2L]))+(((18L*grid_points[0L])*grid_points[1L])*grid_points[2L])))) private(i, j, m) lastprivate(k)
		for (k=1; k<=(grid_points[2]-2); k ++ )
		{
			#pragma cetus private(i, j, m) 
			#pragma loop name exact_rhs#0#4#0 
			for (j=1; j<=(grid_points[1]-2); j ++ )
			{
				#pragma cetus private(i, m) 
				#pragma loop name exact_rhs#0#4#0#0 
				for (i=1; i<=(grid_points[0]-2); i ++ )
				{
					#pragma cetus private(m) 
					#pragma loop name exact_rhs#0#4#0#0#0 
					for (m=0; m<5; m ++ )
					{
