...
#include "/home/reemh/NPB_New/NPB_OMP_P4A2/MG/globals.h"
...
int main()
{
   ...
   print_results("MG", Class, nx[lt], ny[lt], nz[lt], nit, t, mflops, "          floating point", verified, "3.3.1", "27 Aug 2018", "icc", "$(CC)", "-lm -qopenmp", "-I../common", "-g -Wall -O3 -qopenmp -mcmodel=medium", "-O3 -mcmodel=medium", "randdp");
